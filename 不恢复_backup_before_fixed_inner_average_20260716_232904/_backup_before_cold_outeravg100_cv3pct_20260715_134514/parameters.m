...
% 仅随机 pg 端点；保持 pes=pesc=0，避免随机社区净交换污染内层对偶初值。
...
init_mode = 'random_pgonly_feasible_re30_calibrated';
init_target_RE = 0.30;
init_reference_obj = 25940.8260425;
init_random_seed = 20260715;
init_random_mix = 0.548639980076323;
...
save('params.mat','a','b','c','D','start_idx','end_idx', ...
    ...
    'init_mode','init_target_RE','init_reference_obj','init_random_seed','init_random_mix','init_pg_cold', ...
