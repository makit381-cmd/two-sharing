...
load('params.mat','a','b','c','D','start_idx','end_idx', ...
    ...
    'outer_avg_start_price_update','outer_avg_start_iter','outer_price_stable_window','outer_formal_cv_stable_window','record_inner_comm','record_k','progress_print_enabled','progress_print_inner_every','progress_print_outer_every','save_s3_results','run_tag','result_unit','rho_qre','sigma_qre', ...
...
outer.RE_totcost = RE_totcost; % 兼容旧字段；语义见 raw_agg_objective_gap_*。
