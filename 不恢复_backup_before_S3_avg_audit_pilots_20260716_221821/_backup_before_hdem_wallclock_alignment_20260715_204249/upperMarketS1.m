...
outer.outer_history_semantics = ['each entry is the instantaneous raw Agg output at outer k; ', ...
    'RE is objective-gap diagnostic and CV fields are diagnostics, not stop criteria'];
