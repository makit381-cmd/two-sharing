...
agg_cert_tol = 1e-10;
qre_certificate_enabled = true;
agg_certificate_enabled = true;
...
max_inner_iter = 5000; % 仅安全保护，不是理论收敛条件
min_inner_iter = 20;
inner_cv_ratio = 0.01;
...
assert(qre_certificate_enabled && agg_certificate_enabled);
...
save('params.mat','a','b','c','D','start_idx','end_idx', ...
    ...
    'pg_max','pg_min','a_extend','beta_qre', ...
     'qre_epsilon','agg_epsilon','agg_epsilon_i','agg_epsilon_margin','agg_cert_tol','qre_z_cap','qre_backoff_factor','qre_max_backoffs','qre_certificate_enabled','agg_certificate_enabled','qre_error_rel','outer_momentum','inner_momentum','max_inner_iter', ...
     'min_inner_iter','inner_cv_ratio','inner_cv_stop_enabled','stable_inner_window','stable_outer_window','community_load_scale_kW','inner_cv_tol_kW','inner_avg_start_iter', ...
     'max_outer_iter','min_outer_iter','outer_cv_ratio','outer_cv_stop_enabled','outer_cv_l2_tol_kW','system_balance_scale_kW','outer_pb_cv_tol_kW','outer_line_cv_tol_kW','cv_policy', ...
